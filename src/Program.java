...
//        String keystorePath = "C:\\Program Files\\Microsoft\\jdk-11.0.16.101-hotspot\\lib\\security\\cacerts";

        WebServer server = new WebServer(8088, password);

        server.setDataGetting(Program::getData);
        server.setDataParametrizedGetting(Program::getParametrizedData);
